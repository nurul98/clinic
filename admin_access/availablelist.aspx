<%@ Page Title="" Language="C#" MasterPageFile="~/admin_access/admin.Master" AutoEventWireup="true" CodeBehind="availablelist.aspx.cs" Inherits="clinic.admin_access.availablelist" %>
...
<asp:Button ID="canceldelete1" runat="server" Text="Cancel" CssClass="myButton" />
  ...
  <table >
           ...
           <td>
               <asp:DropDownList ID="DropDownDrName" runat="server" 
                   DataSourceID="SqlDataSource1" DataTextField="dr_name" DataValueField="dr_name">
               </asp:DropDownList> 
